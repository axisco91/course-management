...
4. Añadir al servicio externo existente las funciones `local_zonaavz_send_mail`, `local_zonaavz_site_info`, `local_zonaavz_list_courses`, `local_zonaavz_provision_course` y `core_user_get_users`.
