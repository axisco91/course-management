...
class TrainingContractController extends Controller
{
    ...
    public function excludedDays($id){
        return view('training-contracts.excluded-days', compact('id'));
    }
    public function createExamTutorial($training_contract_id){
        return view('exams-tutorials.create', compact('training_contract_id'));
    }
    public function updateExamTutorial($id){
        return view('exams-tutorials.update', compact('id'));
    }
}
