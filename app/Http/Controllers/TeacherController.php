    ...
    public function restTeachers(Request $request){
        ...
        foreach($teachers as $teacher) {
            $info = [
                ...
                'accions' => '<a class="btn btn-success btn-sm" href="teachers/edit_teacher/'.$teacher['id'].'"><i class="far fa-edit"></i></a> <a class="btn btn-danger btn-sm deleteTeacher" data-id="'.$teacher['id'].'"><i class="far fa-trash-alt"></i></a>'
            ];
