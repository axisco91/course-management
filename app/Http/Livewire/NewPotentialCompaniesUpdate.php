...
class NewPotentialCompaniesUpdate extends Component
{
    use WithPagination;
    ...
    public $updateMode = false, $createObservationModal = false, $updateObservationModal = false, $collaborators;
    public $company_types, $company_activities, $cnaes, $provinces, $advisors, $company_id, $observations = null, $route;
    public function render()
    {
        return view('livewire.companies.update_potential');
    }
    ...
    public function convertCliente()
    {
        $this->validate([
            'name' => 'required',
            'type_id' => 'required|numeric|min:1',
