...
class Advisors extends Component
{
    ...
    public $company_types, $company_activities, $cnaes, $provinces, $company_advisors, $incidence_types, $users, $tab = 'info', $advisor_incidences, $advisors_courses, $collaborators;
