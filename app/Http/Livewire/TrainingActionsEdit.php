...
class TrainingActionsEdit extends Component
{
    protected $listeners = ['editTrainingAction'];
    ...
    {
        if ($this->selected_id){
            $record = TrainingAction::findOrFail($this->selected_id);
    ...
    public function editTrainingAction($id){
        $this->selected_id = $id;
    }
}
