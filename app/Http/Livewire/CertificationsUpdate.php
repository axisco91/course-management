...
class CertificationsUpdate extends Component
{
    ...
    public function update()
    {
        $this->validate([
            ...
            'professional_area_id' => 'required|not_in:-1',
            'level' => 'required|not_in:-1'
        ]);
       ...
       // $total_hours = $this-> face_to_face_hours + $this-> teletraining_hours;
        ...
        if ($this->selected_id) {
            ...
            Certification::updateCertification($this->selected_id, $data);

            session()->flash('message', 'Certificado actualizada con exito.');
