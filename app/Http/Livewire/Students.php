    ...
    public function render()
    {
        ...
        return view('livewire.students.view', [
            'students' => Student::latest()
                        ->select('students.*', 'companies.name as company', 'level_studies.name as level_study',
