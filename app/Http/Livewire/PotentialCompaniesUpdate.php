...
class PotentialCompaniesUpdate extends Component
{
    use WithPagination;
    ...
    {
        return view('livewire.companies.updatePotential');
    }
    ...
    public function mount($id){
        ...
        $record = PotentialCompany::findOrFail($id);
    ...
    public function update()
    {
        ...
        if ($this->selected_id) {
            ...
            PotentialCompany::updatePotentialCompany($this->selected_id, $data);

            session()->flash('message', 'Empresa Potencial Actulizado con exito.');
    ...
    public function convertClient()
    {
        ...
        if ($this->selected_id) {
            ...
            Company::convertCompany($this->selected_id, $data);

            session()->flash('message', 'Potencial Convertido con exito.');
            return $this->redirect($this->route);
        }
    }
}
