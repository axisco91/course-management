...
class Billings extends Component
{
    ...
    public $course_search = -1, $company_search = -1, $student_search = -1, $is_bonus_search = -1, $status_search = -1, $course_statuses, $course_name, $company_name, $beginning, $end;
    protected $listeners = [
        'destroy' => 'destroy'
    ];
    ...
    public function render()
    {
        ...
        $billings = Billing::getBillings($keyWord, $this->course_search, $this->company_search, $this->student_search, $this->is_bonus_search, $this->status_search);
