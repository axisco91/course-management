...
class AdvisorsObservations extends Component
{
    protected $paginationTheme = 'bootstrap';
    public $selected_id, $observations, $observation, $observation_id, $advisor_id;
    ...
    public function render()
    {
        ...
        return view('livewire.advisors.advisors-observations');
    }
