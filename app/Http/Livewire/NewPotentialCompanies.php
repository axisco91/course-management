...
class NewPotentialCompanies extends Component
{
    use WithPagination;
    ...
    public function render()
    {
        ...
        $companies = NewPotentialCompany::getNewPotentialCompanies($keyWord, $this->search_name, $this->search_nif, $this->search_type_id, $this->search_activity_id, $this->search_province_id);

        return view('livewire.new-potential-companies.list', [
            'companies' => $companies
        ]);
    }
