    ...
    public function updateChore($id, $data){
        if ($id) {
            ...
            if ($registration->billing_id){
                Billing::updateCloseCommunicationDate($registration->billing_id, Carbon::now()->toDateString(), $data['start_communication_status']);
            }

            $chore->update([
                'membership_tab_status' => $data['membership_tab_status'],
                'membership_tab_date' => $data['membership_tab_date'] == '' ? null : $data['membership_tab_date'],
                'economic_proposal_status' => $data['economic_proposal_status'],
                'economic_proposal_date' => $data['economic_proposal_date'] == '' ? null : $data['economic_proposal_date'],
                'student_tab_status' => $data['student_tab_status'],
                'student_tab_date' => $data['student_tab_date'] == '' ? null : $data['student_tab_date'],
                'welcome_guid_status' => $data['welcome_guid_status'],
                'welcome_guid_date' => $data['welcome_guid_date'] == '' ? null : $data['welcome_guid_date'],
                'registration_status' => $data['registration_status'],
                'registration_date' => $data['registration_date'] == '' ? null : $data['registration_date'],
                'diploma_status' => $data['diploma_status'],
                'diploma_status_date' => $data['diploma_status_date'] == '' ? null : $data['diploma_status_date'],
                'start_communication_status' => $data['start_communication_status'],
                'start_communication_date' => $data['start_communication_date'] == '' ? null : $data['start_communication_date'],
                'close_communication_status' => $data['close_communication_status'],
                'close_communication_date' => $data['close_communication_date'] == '' ? null : $data['close_communication_date'],
                'invoiced_status' => $data['invoiced_status'],
                'invoiced_date' => $data['invoiced_date'] == '' ? null : $data['invoiced_date'],
                'bonus_sent_status' => $data['bonus_sent_status'],
                'bonus_sent_date' => $data['bonus_sent_date'] == '' ? null : $data['bonus_sent_date']
            ]);
