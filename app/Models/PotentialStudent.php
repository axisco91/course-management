...
class PotentialStudent extends Model
{
     ...
     * Get all students
     */
    public function getPotentialStudents($keyWord, $search_name, $search_surname, $search_email, $search_dni, $search_telephone){
     ...
     */
    public function createPotentialStudent($data){
    ...
    public function convertPotentialStudent($id){
        $student = PotentialStudent::update([
            'convert' => 1
        ]);
        return $student;
    }
