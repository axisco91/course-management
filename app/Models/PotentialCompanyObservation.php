...
class PotentialCompanyObservation extends Model
{
    ...
    public function getPotentialCompanyObservations($id){
    ...
    public function createPotentialCompanyObservation($data){
    ...
    public function updatePotentialCompanyObservation($id, $data){
