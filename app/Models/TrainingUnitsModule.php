...
class TrainingUnitsModule extends Model
{
    ...
    public static function deleteTrainingUnitModule($module_id, $training_unit_id){
        $training_unit = TrainingUnit::find($training_unit_id);
        $module = Module::find($module_id);
        $module->update([
            'face_to_face_hours' => $module['face_to_face_hours'] - $training_unit['face_to_face_hours'],
        ...
        $training_unit_module = TrainingUnitsModule::where('training_unit_id', $training_unit_id)
            ->where('module_id', $training_unit_id)->get();
