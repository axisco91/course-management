...
class TrainingContract extends Model
{
    ...
    public static function getTrainingContracts($keyWord, $company_id, $student_id){
        ...
        'training_contract_statuses.name as training_contract_status', 'providers.name as provider')
        ...
        $trainingContract = $trainingContract->orderby('beginning', 'desc')
            ->paginate(10);
    ...
    public static function createTrainingContract($data){
        $training_contract = TrainingContract::create([
            ...
            'formative_hours_first_year' => $data['formative_hours_first_year'],
            'formative_hours_second_year' => $data['formative_hours_second_year'],
