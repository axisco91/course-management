...
class CreateNewPotentialCompaniesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('new_potential_companies', function (Blueprint $table) {
            $table->id();
            $table->string('name');
            ...
            $table->string('advisors_name')->nullable();
    ...
    {
        Schema::dropIfExists('new_potential_companies');
    }
}
