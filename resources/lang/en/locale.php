...
return [
    ...
    'Accordion' => 'Accordion',
    "Offcanvas" => "Offcanvas",
    "message" => "Cake sesame naps cupcake gingerbread danish I love gingerbread. Apple pie pie jujubes chupa chups muffin halvah lollipop. Chocolate cake oat cake tiramisu marzipan sugar plum. Donut sweet pie oat cake dragée fruitcake cotton candy lemon drops.",

    // Menu
    "Students" => "Alumnos",
    "Professional Categories" => "Categorias Profecionales",
    "Level Studies" => "Nivel de Estudios",
    "Teachers" => "Docentes",
    "Teacher Areas" => "Áreas Docente",
    "Companies" => "Empresas",
    "Company Activities" => "Actividades de Empresa",
    "CNAES" => "CNAES",
    "Company Types" => "Tipos de Empresa",
    "Provinces" => "Provincias",
    "Advisors" => "Asesorias",
    "Training Actions" => "Acciones Formativas",
    "Professional Areas" => "Áreas profecionales",
    "Action Types" => "Tipos de Acciones",
    "Professional Families" => "Familias Profecionales",
    "Modalities" => "Modalidades",
    "Training Action Levels" => "Niveles",
    "Tutorings" => "Tutorizaciones",
    "Training Action Groups" => "Grupos",
    "Web Platforms" => "Plataformas",
    "Providers" => "Proveedores",
    "Users" => "Usuarios",
    "Roles" => "Roles",
    "Centers" => "Centros",
    "Courses" => "Cursos",
    "Course Types" => "Tipos de Cursos",
    "Chores" => "Tareas",
    "Tracings" => "Seguimientos",
    "Course Statuses" => "Estado de Cursos",
    "Billings" => "Facturas",
