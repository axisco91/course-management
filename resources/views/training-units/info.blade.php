<!-- Modal -->
<div wire:ignore.self class="modal fade" id="trainingUnitTabModal" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body pb-5 px-sm-5 pt-50">
                <div class="text-center mb-2">
                    <h1 class="mb-1">{{$this->formative_unit}} - {{$this->name}}</h1>
                </div>
                ...
                @if($tab == 'info')
                    <div class="tab-pane container-fluid active" id="general">
                        @include('livewire.training-units.info')
                    </div>
                @endif
            </div>
        </div>
