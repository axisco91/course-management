...
<head>
    ...
    <style>
        ...
        .table-bordered thead th {
            border-bottom: 2px solid rgb(168, 208, 141); /* Color y grosor del borde inferior */
        ...
        .table-bordered tbody tr {
            border-bottom: 2px solid rgb(239, 246, 234); /* Color y grosor del borde inferior */
            border-top: none; /* Eliminar el borde superior */
            border-left: none; /* Eliminar el borde izquierdo */
            border-right: none; /* Eliminar el borde derecho */
            text-align: center; 
        ...
        .table-bordered tbody tr .borde {
            border-bottom: none;  /* Color y grosor del borde inferior */
            border-top: none; /* Eliminar el borde superior */
            border-left: none; /* Eliminar el borde izquierdo */
            border-right: 2px solid rgb(208, 229, 193); /* Eliminar el borde derecho */
        }

        .table-custom tbody tr:nth-child(odd) {
            background-color: rgb(226, 239, 217); /* Color de fondo para las filas impares */
        }
