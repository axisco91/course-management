...
<!-- PRIMERA PÁGINA -->
    ...
    <span class="dots">{{$applicableAgreement->name}} ({{$applicableAgreement->code}})</span>
    ...
    <span class="dots"> {{$applicableAgreement->name}} ({{$applicableAgreement->agreementType->type}}) </span></p>
    <br>
