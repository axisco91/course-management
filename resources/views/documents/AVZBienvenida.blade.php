...
<body>
    ...
    <p>Le recordamos que la fecha de inicio de la formación asociada a su contrato de formación y aprendizaje es el <b><u>{{ \Carbon\Carbon::parse($trainingContract->beginning_formation)->locale('es')->isoFormat('D [de] MMMM [de] Y') }}</u></b> y, por lo tanto, a partir de esa fecha deberá acceder diariamente a la plataforma de teleformación para su realización. La dirección de la citada plataforma es:</p>    <p class="text-center"><b><a href="http://avzformacion.com/aula">http://avzformacion.com/aula</a></b></p>
        ...
        <table class="mt-2" style="border-collapse: collapse; width: 100%;">
            <tr>
                <td width="70%" style="padding: 0; border: none;">
                    <p class="pie-fondo" style="margin: 0; padding-left: 0;">info@avzformacion.com - 957 923 473</p>
                </td>
    ...
    <div style="position: absolute; bottom: 0; width: 100%;">
        <table class="mt-2" style="border-collapse: collapse; width: 100%;">
            <tr>
                <td width="70%" style="padding: 0; border: none;">
                    <p class="pie-fondo" style="margin: 0; padding-left: 0;">info@avzformacion.com - 910 600 410</p>
                </td>
                <td width="30%" style="padding: 0; border: none;" class="text-center">
                    <img src="img-bienvenida/eurocert.PNG" alt="eurocert" class="img-fluid fixed-height-img-eurocert">
                </td>
