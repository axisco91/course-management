@section('title', __('Web Platforms'))
			...
			<div class="card">
				<div class="card-header">
					<div style="display: flex; justify-content: space-between; align-items: center;">
						...
						<i class="fa fa-plus"></i>  Añadir plataforma
						</div>
					</div>
				</div>

				<div class="card-body">
						@include('livewire.web-platforms.create')
						@include('livewire.web-platforms.update')
