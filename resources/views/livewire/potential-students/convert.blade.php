<div class="card-body">
    ...
    <form class="form needs-validation" novalidate>
        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="mb-1">
                    ...
                    <textarea wire:model.lazy="comment" class="form-control @error('comment') is-invalid @enderror" rows="4" placeholder="Comentario"></textarea>
        ...
        <div class="col-12">
            ...
            <button id="save" type="button" wire:click.prevent="convert()" class="btn btn-primary me-1">Guardar</button>
        </div>
    </form>
