    ...
    <form class="form needs-validation" novalidate>
        <div class="row">
            ...
            <div class="col-md-4 col-12 mb-1">
                ...
                <input wire:model.lazy="company_name" type="text" class="form-control @error('company_name') is-invalid @enderror" id="company_name" placeholder="Nombre Empresa">
            ...
            <div class="col-md-4 col-12">
                <div wire:ignore>
                    <div class="mb-1">
                        <label class="form-label" for="professional_family_id">Familia Professional</label>
                        <select class="form-select select2 @error('professional_family_id') is-invalid @enderror" wire:model.lazy="professional_family_id" id="professional_family_id">
            ...
            <div class="col-md-4 col-12">
                <div wire:ignore>
                    <div class="mb-1">
                        <label class="form-label" for="professional_area_id">Categoria Profesional</label>
                        <select class="form-select select2 @error('professional_area_id') is-invalid @enderror" wire:model.lazy="professional_area_id" id="professional_area_id">
            ...
            <div class="col-md-4 col-12">
                <div wire:ignore>
                    <div class="mb-1">
                        <label class="form-label" for="training_action_id">Curso</label>
                        <select class="form-select select2 @error('training_action_id') is-invalid @enderror" wire:model.lazy="training_action_id" id="training_action_id">
                            <option value="">Seleccione un curso</option>
                            @foreach($training_actions as $course)
                                <option value="{{$course['id']}}">{{$course['name']}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                @error('training_action_id') <div class="invalid-feedback">{{ $message }}</div> @enderror
            </div>
        </div>
        <div class="col-12">
