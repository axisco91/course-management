<div class="card">
    <div class="card-header border-bottom">
        <h4 class="card-title">Dia Excluido</h4>
        ...
        @endif
        @include('livewire.excluded-days.create')
        @include('livewire.excluded-days.update')
    </div>
        ...
        <div class="row g-1 mb-md-1">
            ...
            <div class="col-md-4">
                <div wire:ignore class="btn btn-sm btn-info" data-bs-toggle="modal" data-bs-target="#createDataModal">
                    <i class="fa fa-plus" class="me-50"></i> Añadir Dia Excluido
                </div>
            </div>
        </div>
    </div>
