<div class="card">
    <div class="card-header border-bottom">
        <h4 class="card-title">Ocupaciones</h4>
        ...
        @endif
        @include('livewire.occupations.create')
        @include('livewire.occupations.update')
    </div>
        ...
        <div class="row g-1 mb-md-1">
            ...
            <div class="col-md-4">
                <div wire:ignore class="btn btn-sm btn-info" data-bs-toggle="modal" data-bs-target="#createDataModal">
                    <i class="fa fa-plus" class="me-50"></i> Añadir Ocupación
                </div>
            </div>
        </div>
    </div>
        ...
        document.addEventListener('livewire:load', function () {
            $('body').on('click', '.eliminar', function () {
                ...
                swalWithBootstrapButtons.fire({
                    title: '¿Estas seguro?',
                    text: "Eliminaras a la ocupación!",
                    icon: 'warning',
