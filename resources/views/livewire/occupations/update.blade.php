        ...
        <div class="modal-content">
            ...
            <div class="modal-body pb-5 px-sm-5 pt-50">
                <div class="text-center mb-2">
                    <h1 class="mb-1">Editar Ocupación</h1>
                </div>
                <form id="editCnaeForm" class="row gy-1 pt-75" onsubmit="return false">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <input wire:model="name" type="text" class="form-control @error('name') is-invalid @enderror" id="name" placeholder="Cnae">@error('name') <div class="invalid-feedback">Ocupación es requerido</div> @enderror
                        </div>
                    </div>
