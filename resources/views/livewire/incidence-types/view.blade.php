<div class="card">
    <div class="card-header border-bottom">
        <h4 class="card-title">Tipos Incidencias</h4>
        ...
        @endif
        @include('livewire.incidence-types.update')
        @include('livewire.incidence-types.create')
    </div>
        ...
        <div class="row g-1 mb-md-1">
            ...
            <div class="col-md-4">
                <div wire:ignore class="btn btn-sm btn-info" data-bs-toggle="modal" data-bs-target="#createDataModal">
                    <i class="fa fa-plus" class="me-50"></i> Añadir Tipo Incidencia
                </div>
            </div>
        </div>
    </div>
        ...
        document.addEventListener('livewire:load', function () {
            $('body').on('click', '.eliminar', function () {
                ...
                swalWithBootstrapButtons.fire({
                    title: '¿Estas seguro?',
                    text: "Eliminaras al tipo de incidencia!",
                    icon: 'warning',
