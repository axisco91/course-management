<div class="card-body">
    <div class="mb-1">
        <a class="btn" href="{{asset('/advisors/edit/'.$advisor_id)}}">General</a>
    ...
    <div class="col-12 mt-2 pt-50">
        ...
        @else
            <button type="button" wire:click.prevent="create" class="btn btn-primary" data-bs-dismiss="modal">Guardar</button>
        @endif
    </div>
    <br>
    <hr class="my-0" />
