			...
			<div class="card">
				<div class="card-header">
					<div style="display: flex; justify-content: space-between; align-items: center;">
						...
						<i class="fa fa-plus"></i>  Añadir Cnae
						</div>
					</div>
				</div>

				<div class="card-body">
						@include('livewire.cnaes.create')
						@include('livewire.cnaes.update')
