			...
			<div class="card">
				<div class="card-header">
					<div style="display: flex; justify-content: space-between; align-items: center;">
						...
						<i class="fa fa-plus"></i>  Añadir Modalidad
						</div>
					</div>
				</div>

				<div class="card-body">
						@include('livewire.modalities.create')
						@include('livewire.modalities.update')
