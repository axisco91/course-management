    ...
    <div class="modal-dialog modal-xl" role="document">
       <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="updateModalLabel">Editar Alumno</h5>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-4">
                            <div wire:ignore>
                                ...
                                <select class="form-control select2" wire:model.lazy="company_id" id="company_id">
                        ...
                        <div class="form-group col-4">
                            <div wire:ignore>
                                ...
                                <select class="form-control select2" wire:model.lazy="level_study_id" id="level_study_id">
                        ...
                        <div class="form-group col-4">
                            <div wire:ignore>
                                ...
                                <select class="form-control select2" wire:model.lazy="professional_category_id" id="professional_category_id">
