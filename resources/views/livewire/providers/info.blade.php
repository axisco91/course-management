<div class="row">
    <div class="col-12 mb-1">
        <a class="btn btn-success right" href="{{url('/providers/edit/'.$this->selected_id)}}" target="_blank"><i class="fa-solid fa-pencil"></i></a>
    </div>
    ...
    <div class="col-md-4 col-12">
        <div class="mb-1">
            ...
            <input wire:model.lazy="irpf" type="text" class="form-control" id="irpf" placeholder="Irpf" disabled>@error('irpf') <div class="invalid-feedback">{{ $message }}</div> @enderror
        </div>
    </div>
    <div class="col-md-4 col-12">
        <div class="mb-1">
    ...
    <div class="col-md-4 col-12">
        <div class="mb-1">
            ...
            <input wire:model.lazy="contact_1" type="text" class="form-control" id="contact_1" placeholder="Contacto 1" disabled>@error('contact_1') <div class="invalid-feedback">{{ $message }}</div> @enderror
        </div>
    </div>
    <div class="col-md-4 col-12">
        <div class="mb-1">
            <label class="form-label" for="contact_2">Contacto 2</label>
            <input wire:model.lazy="contact_2" type="text" class="form-control" id="contact_2" placeholder="Contacto 2" disabled>@error('contact_2') <div class="invalid-feedback">{{ $message }}</div> @enderror
        </div>
    </div>
    <div class="col-md-4 col-12">
        <div class="mb-1">
            <label class="form-label" for="contact_3">Contacto 3</label>
            <input wire:model.lazy="contact_3" type="text" class="form-control" id="contact_3" placeholder="Contacto 3" disabled>@error('contact_3') <div class="invalid-feedback">{{ $message }}</div> @enderror
        </div>
    </div>
</div>
