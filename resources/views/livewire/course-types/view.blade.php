<div class="card">
    <div class="card-header border-bottom">
        <h4 class="card-title">Tipos Cursos</h4>
        ...
        @endif
        @include('livewire.course-types.update')
        @include('livewire.course-types.create')
    </div>
        ...
        <div class="row g-1 mb-md-1">
            ...
            <div class="col-md-4">
                <div class="btn btn-sm btn-info" data-bs-toggle="modal" data-bs-target="#createDataModal">
                    <i class="fa fa-plus"></i>  Añadir Tipo Curso
                </div>
            </div>
        </div>
    </div>
