    ...
    <div class="modal-dialog" role="document">
       <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="updateModalLabel">Editar Tipo Curso</h5>
            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <input wire:model="name" type="text" class="form-control" id="name" placeholder="Nomber">@error('name') <span class="error text-danger">{{ $message }}</span> @enderror
                    </div>
                </form>
            </div>
