<div class="card">
    <div class="card-header border-bottom">
        <h4 class="card-title">Estados Curso</h4>
        ...
        @endif
        @include('livewire.course-statuses.create')
        @include('livewire.course-statuses.update')
    </div>
        ...
        <div class="row g-1 mb-md-1">
            ...
            <div class="col-md-4">
                <div class="btn btn-sm btn-info" data-bs-toggle="modal" data-bs-target="#createDataModal">
                    <i data-feather="plus-circle" class="me-50"></i> Añadir Estado
                </div>
            </div>
        </div>
    </div>
        ...
        document.addEventListener('livewire:load', function () {
            $('body').on('click', '.eliminar', function () {
                ...
                swalWithBootstrapButtons.fire({
                    title: '¿Estas seguro?',
                    text: "Eliminaras al estado del curso!",
                    icon: 'warning',
