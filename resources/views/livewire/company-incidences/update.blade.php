<div class="card-body">
    <form>
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-12">
                <div wire:ignore>
                    <label class="form-label" for="company_id">Companies</label>
                    <select wire:model.lazy="company_id" class="form-select select2" id="company_id" placeholder="Company" disabled>
