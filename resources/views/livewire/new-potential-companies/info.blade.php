<div class="row">
    <div class="col-12 mb-1">
        <a class="btn btn-success right" href="{{url('/companies/edit/'.$this->selected_id)}}" target="_blank"><i class="fa-solid fa-pencil"></i></a>
    </div>
    ...
    <div class="mb-1">
        <label class="form-label" for="advisor_name">Asesoria</label>
        <input wire:model.lazy="advisor_name" type="text" class="form-control @error('advisor_name') is-invalid @enderror" id="advisor_name" placeholder="Nombre Asesoria">
        @error('advisor_name') <div class="invalid-feedback">Nombre asesoria es requerido</div> @enderror
    </div>
    <div class="col-md-4 col-12 mb-1">
        <div wire:ignore>
