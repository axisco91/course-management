        ...
        <div class="row">
            <div class="col-12 col-md-3">
                <div class="mb-1">
                    ...
                    <input wire:model.lazy="formative_unit" type="text" class="form-control" id="formative_unit" disabled placeholder="Unidad Formativa">@error('formative_unit') <div class="invalid-feedback">{{ $message }}</div> @enderror
                </div>
            </div>
            <div class="col-12 col-md-3">
                <div class="mb-1">
