    ...
    <div class="modal-dialog modal-lg" role="document">
       <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="updateModalLabel">Update Company Observation</h5>
            ...
            <div class="modal-body">
              ...
              <div class="col-12 text-center mt-2 pt-50">
                ...
                <button type="button" wire:click.prevent="update()" class="btn btn-primary close-model">Save</button>
            </div>
       </div>
    </div>
</div>
