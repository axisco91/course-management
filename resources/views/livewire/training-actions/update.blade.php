        ...
        <div class="row">
            ...
            <div class="col-12 col-md-3 mb-1">
                <div wire:ignore>
                    ...
                    <select wire:model.lazy="action_type_id" class="form-select select2 @error('action_type_id') is-invalid @enderror" id="action_type_id">
           ...
           <div class="col-md-3 col-12 mb-1">
                <div wire:ignore>
                    ...
                    <select wire:model.lazy="modality_id" class="form-select select2 @error('modality_id') is-invalid @enderror" id="modality_id">
           ...
           <div class="col-md-3 col-12 mb-1">
                <div wire:ignore>
                    ...
                    <select wire:model.lazy="training_action_level_id" class="form-select select2 @error('training_action_level_id') is-invalid @enderror" id="training_action_level_id">
           ...
           <div class="col-md-3 col-12 mb-1">
                <div wire:ignore>
                    ...
                    <select wire:model.lazy="training_action_group_id" class="form-select select2 @error('training_action_group_id') is-invalid @enderror" id="training_action_group_id">
           ...
           <div class="col-md-3 col-12 mb-1">
                <div wire:ignore>
                    ...
                    <select wire:model.lazy="tutoring_id" class="form-select select2 @error('tutoring_id') is-invalid @enderror" id="tutoring_id">
           ...
           <div class="col-md-2 col-12 mb-1">
                ...
                <select wire:model.lazy="course_z" class="form-select @error('course_z') is-invalid @enderror" id="course_z">
           ...
           <div class="col-md-2 col-12 mb-1">
                ...
                <select wire:model.lazy="course_avz" class="form-select @error('course_avz') is-invalid @enderror" id="course_avz">
                    <option value="0">No</option>
                    <option value="1">Si</option>
                </select>
           ...
           <div class="col-md-2 col-12">
               <div class="mb-1">
                    <br>
                    <label class="form-label" for="active"><input wire:model.lazy="active" type="checkbox" id="active" value="active" {{$active == 1 ? 'checked' : ''}}> Activo</label>
           ...
           <div class="col-md-3 col-12">
               <div class="mb-1">
                    <br>
                    <label class="form-label" for="in_catalog"> <input wire:model.lazy="in_catalog" type="checkbox" id="in_catalog" value="in_catalog" {{$in_catalog == 1 ? 'che' : ''}}> En Catalogo</label>
            ...
            <div class="col-12 col-md-3">
                <div class="mb-1">
                    ...
                    <input wire:model.lazy="face_to_face_hours" type="text" class="form-control @error('face_to_face_hours') is-invalid @enderror" id="face_to_face_hours" placeholder="Horas Presenciales">
            ...
            <div class="col-md-12">
                <div class="mb-1">
                    ...
                    <textarea wire:model.lazy="objectives" rows="20"  class="form-control @error('objectives') is-invalid @enderror" id="objectives" placeholder="Objetivos"></textarea>
            ...
            <div class="col-12">
                <div class="mb-1">
                    ...
                    <textarea wire:model.lazy="content" rows="20" class="form-control @error('content') is-invalid @enderror" id="content" placeholder="Contenido"></textarea>@error('content') <div class="invalid-feedback">{{ $message }}</div> @enderror
                </div>
            </div>
           <div class="col-md-4 col-12">
               <div class="mb-1">
                   <label class="form-label" for="user">Usuario</label>
                   <input wire:model.lazy="user" type="text" class="form-control @error('user') is-invalid @enderror" id="user" placeholder="Usuario">@error('user') <div class="invalid-feedback">{{ $message }}</div> @enderror
               </div>
            </div>
           <div class="col-md-4 col-12">
                <label class="form-label" for="password">Contraseña</label>
                <input wire:model.lazy="password" type="text" class="form-control @error('password') is-invalid @enderror" id="password" placeholder="Contraseña">@error('password') <div class="invalid-feedback">{{ $message }}</div> @enderror
            </div>
           <div class="col-md-4 col-12 mb-1">
                <div wire:ignore>
                    <label class="form-label" for="web_platform_id">Plataforma</label>
                    <select wire:model.lazy="web_platform_id" class="form-select select2 @error('web_platform_id') is-invalid @enderror" id="web_platform_id">
            ...
            <div class="col-12">
                <div class="mb-1">
                    ...
                    <textarea wire:model.lazy="observations" rows="10" class="form-control @error('observations') is-invalid @enderror" id="observations" placeholder="Observaciones"></textarea>@error('observations') <div class="invalid-feedback">{{ $message }}</div> @enderror
                </div>
            </div>
           <div class="col-md-4 col-12">
               <div class="mb-1">
                    <label class="form-label" for="number_activities">Numero Actividades</label>
                    <input wire:model.lazy="number_activities" type="number" class="form-control @error('number_activities') is-invalid @enderror" id="number_activities" placeholder="Numero Actividades">@error('number_activities') <div class="invalid-feedback">{{ $message }}</div> @enderror
               </div>
            </div>
           <div class="col-md-4 col-12">
               <div class="mb-1">
                    <label class="form-label" for="number_units">Numero Unidades</label>
                    <input wire:model.lazy="number_units" type="number" class="form-control @error('number_unts') is-invalid @enderror" id="number_units" placeholder="Numero Unidades">@error('number_units') <div class="invalid-feedback">{{ $message }}</div> @enderror
               </div>
            </div>
           <div class="col-md-4 col-12 mb-1">
                <div wire:ignore>
