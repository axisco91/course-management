<div class="card">
    <div class="card-header border-bottom">
        <h4 class="card-title">Tipo Acciones</h4>
        ...
        @endif
        @include('livewire.action-types.create')
        @include('livewire.action-types.update')
    </div>
