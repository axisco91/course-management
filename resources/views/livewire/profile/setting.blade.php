<div class="app-content">
    @if (session()->has('message'))
        <input hidden id="success-toast" data-type="success" data-show="true" value="Usuario editado con exito.">
    @endif
                ...
                <div class="col-12" wire:ignore>
                    <ul class="nav nav-pills mb-2">
                        ...
                        <li class="nav-item" style="margin-left: 10px">
                            <a class="nav-link btn-info" href="/user/change_password">
                                <i data-feather="user" class="font-medium-3 me-50"></i>
                        ...
                        <!--    <div class="d-flex">
                              ...
                              <!--  <div class="d-flex align-items-end mt-75 ms-1">
                                    <div>
                                        ...
                                        <input type="file" id="account-upload" hidden accept="image/*" wire:model="photo"/>
                           ...
                           <!-- </div> -->
                            ...
                            <form class="validate-form mt-2 pt-50">
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <button type="submit" wire:click.prevent="update()" class="btn btn-primary mt-1 me-1">Guardar</button>
