<div wire:ignore.self class="modal fade" id="createCreditModal" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body pb-5 px-sm-5 pt-50">
                <div class="text-center mb-2">
                    <h1 class="mb-1">Crear Credito</h1>
                </div>
                <form id="createCreditForm" class="row gy-1 pt-75" onsubmit="return false">
                    <div class="row">
                    ...
                    <div class="col-12 text-center mt-2 pt-50">
                        ...
                        <button type="button" wire:click.prevent="createCredit()" class="btn btn-primary" data-bs-dismiss="modal">Guardar</button>
                    </div>
                </form>
            </div>
        </div>
