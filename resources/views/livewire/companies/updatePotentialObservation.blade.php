<!-- Modal -->
<div wire:ignore.self class="modal fade" id="updatePotentialObservation" data-bs-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="updateModalLabel" aria-hidden="true" style="z-index: 1062 !important;">
       ...
       <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="col-12 text-center mt-2 pt-50">
                ...
                <button type="button" wire:click.prevent="updatePotentialObservation()" class="btn btn-primary close-model">Guardar</button>
            </div>
       </div>
    </div>
</div>
