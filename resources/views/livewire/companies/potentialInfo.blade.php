<div class="row">
    <div class="col-12 mb-1">
        <a class="btn btn-success right" href="{{url('/companies/edit_potential/'.$this->selected_id)}}" target="_blank"><i class="fa-solid fa-pencil"></i></a>
    </div>
    ...
    <div class="col-md-4 col-12">
        <div class="form-check form-check-inline" style="padding-top: 32px;">
            <input wire:model.lazy="potential" class="form-check-input @error('potential') is-invalid @enderror" type="checkbox" id="potential" value="potential" disabled/>
