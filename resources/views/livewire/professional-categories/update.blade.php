        ...
        <div class="modal-content">
            ...
            <div class="modal-body pb-5 px-sm-5 pt-50">
                <div class="text-center mb-2">
                    <h1 class="mb-1">Editar Categoria</h1>
                </div>
                <form id="editCategoryForm" class="row gy-1 pt-75" onsubmit="return false">
                    <input type="hidden" wire:model="selected_id">
                    <div class="row">
                        <div class="col-12">
                            <label class="form-label" for="name">Categoria</label>
                            <input wire:model="name" type="text" class="form-control" id="name" placeholder="Categoria">@error('name') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>
                    </div>
