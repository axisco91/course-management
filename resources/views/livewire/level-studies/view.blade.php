	...
	<div class="row justify-content-center">
		<div class="col-md-12">
			<div class="card">
				...
				<div class="card-body">
						@include('livewire.level-studies.create')
						@include('livewire.level-studies.update')
