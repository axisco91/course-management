        ...
        <div class="modal-content">
            ...
            <div class="modal-body pb-5 px-sm-5 pt-50">
                <div class="text-center mb-2">
                    <h1 class="mb-1">Editar Nivel Estudio</h1>
                </div>
                <form id="editLevelForm" class="row gy-1 pt-75" onsubmit="return false">
                    ...
                    <div class="row">
                        <div class="form-group">
                            ...
                            <input wire:model="name" type="text" class="form-control" id="name" placeholder="Nivel">@error('name') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>
                    </div>
