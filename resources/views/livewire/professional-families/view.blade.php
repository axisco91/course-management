@section('title', __('Professional Familys'))
			...
			<div class="card">
				<div class="card-header">
					<div style="display: flex; justify-content: space-between; align-items: center;">
						...
						<i class="fa fa-plus"></i>  Añadir Familia
						</div>
					</div>
				</div>

				<div class="card-body">
						@include('livewire.professional-families.create')
						@include('livewire.professional-families.update')
				<div class="table-responsive">
					<table class="table table-bordered table-sm">
						...
						<tbody>
							@foreach($professionalFamilies as $row)
							<tr>
