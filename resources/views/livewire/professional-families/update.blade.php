        ...
        <div class="modal-content">
            ...
            <div class="modal-body pb-5 px-sm-5 pt-50">
                <div class="text-center mb-2">
                    <h1 class="mb-1">Editar Familia Profesional</h1>
                </div>
                <form id="editProfessionalForm" class="row gy-1 pt-75" onsubmit="return false">
                    <input type="hidden" wire:model="selected_id">
                    <div class="row">
                        <div class="col-12">
                            <label class="form-label" for="name">Familia</label>
                            <input wire:model="name" type="text" class="form-control @error('name') is-invalid @enderror" id="name" placeholder="Familia">@error('name') <div class="invalid-feedback">Familia es requerido</div> @enderror
                        </div>
                    </div>
