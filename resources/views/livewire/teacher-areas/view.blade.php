<div class="card">
    <div class="card-header border-bottom">
        <h4 class="card-title">Áreas Docentes</h4>
        ...
        @endif
        @include('livewire.teacher-areas.create')
        @include('livewire.teacher-areas.update')
    </div>
        ...
        <div class="row g-1 mb-md-1">
            ...
            <div class="col-md-4">
                <div class="btn btn-sm btn-info" data-bs-toggle="modal" data-bs-target="#createDataModal">
                    <i class="fa fa-plus"></i>  Añadir Área Docente
                </div>
            </div>
        </div>
    </div>
