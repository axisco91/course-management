        ...
        <div class="modal-content">
            ...
            <div class="modal-body pb-5 px-sm-5 pt-50">
                <div class="text-center mb-2">
                    <h1 class="mb-1">Crear Área Docente</h1>
                </div>
                <form id="createAreaForm" class="row gy-1 pt-75" onsubmit="return false">
                    <div class="row">
                        <div class="col-12">
                            <label class="form-label" for="name">Área</label>
                            <input wire:model="name" type="text" class="form-control @error('name') is-invalid @enderror" id="name" placeholder="Área">@error('name') <div class="invalid-feedback">Área es requerido</div> @enderror
                        </div>
                    </div>
