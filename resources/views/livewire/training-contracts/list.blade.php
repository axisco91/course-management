        ...
        <table class="table table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td data-bs-toggle="modal" data-bs-target="#trainingContractTabModal" wire:click="general({{$row->id}})">{{ $row->contract_type == 0 ? 'Discapacitado' : ($row->contract_type == 1 ? 'Garantia Juvenil' : ($row->contract_type == 2 ? 'Exclusión Social' : ''))}}</td>
                    ...
                    <td data-bs-toggle="modal" data-bs-target="#trainingContractTabModal" wire:click="general({{$row->id}})">{{ $row->beginning_formation }}</td>
                    <td data-bs-toggle="modal" data-bs-target="#trainingContractTabModal" wire:click="general({{$row->id}})">{{ $row->end_formation }}</td>
                    <td>
                        <div class="dropdown">
