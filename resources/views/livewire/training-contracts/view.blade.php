<div class="card-body">
    <div class="col-12 mb-1">
        <a href="{{url('/training_contracts/edit/'.$this->selected_id)}}" class="btn btn-success right">Editar</a>
    </div>
    <form class="form needs-validation" novalidate>
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-12 mb-1">
                <div wire:ignore>
                    <label class="form-label" for="excluded_day_id">Dias Excluidos</label>
                    <select wire:model.lazy="excluded_day_id" class="form-select" id="excluded_day_id" multiple disabled>
                        <option value="-1">Seleccione dias exluidos</option>
                        @foreach($excluded_days as $excluded_day)
                            <option value="{{$excluded_day['id']}}">{{$excluded_day['day']}}</option>
                        @endforeach
                    </select>
                </div>
            </div>
        ...
        <div class="col-12 col-md-3">
            <div class="mb-1">
                ...
                <input wire:model.lazy="code" type="text" class="form-control" id="code" placeholder="Codigo" disabled>@error('codigo') <div class="invalid-feedback">{{ $message }}</div> @enderror
            </div>
        </div>
        <div class="col-md-3 col-12 mb-1">
            <div wire:ignore>
        ...
        <div class="col-md-3 col-12 mb-1">
            <div wire:ignore>
                <label class="form-label" for="professional_family_id">Proveedores</label>
        ...
        <div class="col-md-3 col-12 mb-1">
            <div wire:ignore>
                ...
                <select wire:model.lazy="training_action_level_id" class="form-select select2 @error('training_action_level_id') is-invalid @enderror" id="training_action_level_id" disabled>
                    <option value="-1">Seleccione un un nivel</option>
                    @foreach($training_action_levels as $training_action_level)
                        <option value="{{$training_action_level['id']}}">{{$training_action_level['name']}}</option>
                    @endforeach
                </select>
            </div>
            @error('professional_area_id') <div class="invalid-feedback">Colaborador es requerido</div> @enderror
