        ...
        <div class="row">
            ...
            <div class="col-md-3 col-12 mb-1">
                <div wire:ignore>
                    ...
                    <select wire:model.lazy="excluded_day_id" class="form-select select2 @error('excluded_day_id') is-invalid @enderror" id="excluded_day_id" multiple>
                ...
                @error('excluded_day_id') <div class="invalid-feedback">{{ $message }}</div> @enderror
            </div>
