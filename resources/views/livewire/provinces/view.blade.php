<div class="card">
    <div class="card-header border-bottom">
        ...
        @endif
        @include('livewire.provinces.create')
        @include('livewire.provinces.update')
    </div>
        ...
        <div class="row g-1 mb-md-1">
            ...
            <div class="col-md-4">
                <div wire:ignore class="btn btn-sm btn-info" data-bs-toggle="modal" data-bs-target="#createDataModal">
                    <i data-feather="plus-circle" class="me-50"></i> Añadir Provincia
                </div>
            </div>
        </div>
    </div>
        ...
        document.addEventListener('livewire:load', function () {
            $('body').on('click', '.eliminar', function () {
                ...
                swalWithBootstrapButtons.fire({
                    title: '¿Estas seguro?',
                    text: "Eliminaras a la provincia!",
                    icon: 'warning',
