<div class="card-body">
    <div class="col-12 mb-1">
        <button type="button" class="btn btn-success right" id="enable_edit_teachers">Editar</button>
    </div>
    <form class="form">
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-12">
                <div class="mb-1">
                    ...
                    <input wire:model.lazy="telephone" type="text" class="form-control" id="telephone" placeholder="Telefono">
           ...
           <div class="col-md-4 col-12 mb-1">
                <div wire:ignore>
                    ...
                    <select class="form-select select2" wire:model.lazy="teacher_area_id" id="teacher_area_id" multiple>
            ...
            <div class="col-md-4 col-12">
               <div class="mb-1">
                    ...
                    <input wire:model.lazy="address" type="text" class="form-control" id="address" placeholder="Dirección">@error('direction') <div class="invalid-feedback">{{ $message }}</div> @enderror
               </div>
            </div>
            <div class="col-md-4 col-12">
               <div class="mb-1">
