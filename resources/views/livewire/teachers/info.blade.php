 <div class="row">
    <div class="col-12 mb-1">
        <a class="btn btn-success right" href="{{url('/teachers/edit/'.$this->selected_id)}}" target="_blank"><i class="fa-solid fa-pencil"></i></a>
    </div>
    ...
    <div class="col-md-4 col-12 mb-1">
        <div wire:ignore>
            ...
            @if($teacher_area_id)
            <select class="form-select" wire:model.lazy="teacher_area_id" id="teacher_area_id" multiple disabled>
            ...
            @else
                <select class="form-select" wire:model.lazy="teacher_area_id" id="teacher_area_id" disabled>
    ...
    <div class="col-md-4 col-12 mb-1">
        <div wire:ignore>
            ...
            <select class="form-select @error('province-id') is-invalid @enderror" wire:model.lazy="province_id" id="province_id" disabled>
