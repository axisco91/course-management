        ...
        <div class="modal-content">
            ...
            <div class="modal-body pb-5 px-sm-5 pt-50">
                <div class="text-center mb-2">
                    <h1 class="mb-1">{{ str_replace( ' -', '/'.$this->course_group.' -', $this->course_name)}} - {{$this-> student_name}} - {{$this-> beginning}} / {{$this-> end}}</h1>
                </div>
                    ...
                    <div class="tab-pane container active" id="general">
                        <div class="row">
                            <div class="col-12 mb-1">
                                <button type="button" class="btn btn-success right" id="enable_edit_tracings">Editar</button>
                            </div>
