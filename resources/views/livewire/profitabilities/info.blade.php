<div class="row">
    ...
    <div class="col-md-4 col-12 mb-1">
        <label class="form-label" for="student_id">Alumno</label> @if($this->student_id)<a href="{{url('/students/view/'.$this->student_id)}}" target="_blank" class="view"><i class="fa-regular fa-eye"></i></a>
        @endif
        <div wire:ignore>
