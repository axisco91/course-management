<div class="card">
    <div class="card-header border-bottom">
        <h4 class="card-title">Estados Contrato Formativo</h4>
        ...
        @endif
        @include('livewire.training-contract-statuses.create')
        @include('livewire.training-contract-statuses.update')
    </div>
        ...
        <div class="row g-1 mb-md-1">
            ...
            <div class="col-md-4">
                <div wire:ignore class="btn btn-sm btn-info" data-bs-toggle="modal" data-bs-target="#createDataModal">
                    <i class="fa fa-plus" class="me-50"></i> Añadir Estado
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="table-responsive">
        <table class="table table-hover">
            ...
            <tbody>
                @foreach($training_contract_statuses as $row)
                <tr>
        ...
        {{ $training_contract_statuses->links() }}
        </div>
    </div>
@section('scripts')
    <script>
        ...
        document.addEventListener('livewire:load', function () {
            $('body').on('click', '.eliminar', function () {
                ...
                swalWithBootstrapButtons.fire({
                    title: '¿Estas seguro?',
                    text: "Eliminaras al estado del contrato formativo!",
                    icon: 'warning',
