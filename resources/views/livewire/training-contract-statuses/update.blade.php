        ...
        <div class="modal-content">
            ...
            <div class="modal-body pb-5 px-sm-5 pt-50">
                <div class="text-center mb-2">
                    <h1 class="mb-1">Editar Estado Contrato Formativo</h1>
                </div>
                <form id="editStatusForm" class="row gy-1 pt-75" onsubmit="return false">
                    <input type="hidden" wire:model="selected_id">
                    <div class="row">
                        <div class="col-12">
                            <label class="form-label" for="name">Estado</label>
                            <input wire:model="name" type="text" class="form-control @error('name') is-invalid @enderror" id="name" placeholder="Estado">@error('name') <div class="invalid-feedback">Estado es requerido</div> @enderror
                        </div>
                    </div>
