    ...
    <form class="form needs-validation" novalidate>
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-12 mb-1">
                ...
                <input wire:model.lazy="beginning" type="date" class="form-control" id="beginning">@error('beginning') <div class="invalid-feedback">Fecha inicio es requerido</div> @enderror
            </div>
            <div class="col-md-4 col-12 mb-1">
                <label class="form-label" for="end">Fecha Fin</label>
                <input wire:model.lazy="end" type="date" class="form-control" id="end">@error('end') <div class="invalid-feedback">Fecha fin es requerido</div> @enderror
            </div>
            <div class="col-md-4 col-12 mb-1">
