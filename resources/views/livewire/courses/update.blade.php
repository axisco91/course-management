    ...
    <div class="modal-dialog modal-xl" role="document">
       <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="updateModalLabel">Editar Curso</h5>
            ...
            <div class="modal-footer">
                ...
                <buttxon type="button" wire:click.prevent="update()" class="btn btn-primary" data-bs-dismiss="modal">Guardar</buttxon>
            </div>
       </div>
        <script>
            document.addEventListener('livewire:load', function() {
                ...
                //    $('#training_action_id').select2('val', '' + @this.training_action_id + '')
