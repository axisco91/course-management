        ...
        <div class="row">
            ...
            <div class="col-md-4 col-12 mb-1">
                <div wire:ignore>
                    ...
                    <select wire:model.lazy="course_type_id" class="form-control select2" id="course_type_id" disabled>
            ...
            <div class="col-md-4 col-12 mb-1">
                <div wire:ignore>
                    ...
                    <select wire:model.lazy="formation_center_id" class="form-control select2" id="formation_center_id" disabled>
            ...
            <div class="col-md-4 col-12 mb-1">
                <div wire:ignore>
                    ...
                    <select wire:model.lazy="delivery_center_id" class="form-control select2" id="delivery_center_id" disabled>
