                 ...
                 <div class="card ecommerce-card">
                     ...
                     <div class="item-name" style="display: flex;flex-direction: row;justify-content: space-between;background-color: orange;padding: 4px;align-items: center;">
                         <div style="display: flex;flex-direction: row;align-content: stretch;flex-wrap: nowrap;justify-content: center;">
                             ...
                             <h5 class="item-company" style="margin-right: 5px">{{$company_incidence['incidence_type']}}</h5>
                             <h5 class="item-company" style="margin-right: 5px">{{$company_incidence['user']}}</h5>
                         </div>
                         <div>
                             <a class="btn btn-sm btn-success" href="{{url('/company_history/edit/'.$company_incidence['id'])}}" target="_blank"><i class="fa-solid fa-pencil"></i></a>
