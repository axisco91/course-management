                ...
                <form>
                    ...
                    <div class="row">
                       <div class="col-md-4 col-12">
                            ...
                            <input wire:model="name" type="text" class="form-control" id="name" disabled placeholder="Nombre">@error('name') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>
                       <div class="col-md-4 col-12">
                       ...
                       <div class="col-md-4 col-12">
                            <label class="form-label" for="group">Actividades Realizadas</label>
                            <input wire:model="performed_activities" type="number" class="form-control" id="group" placeholder="Grupo" disabled>@error('group') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>
                       <div class="col-md-4 col-12">
                       ...
                       <div class="col-md-4 col-12">
                            ...
                            <input wire:model="nebrija" type="text" class="form-control" id="nebrija" placeholder="Nebrija">@error('nebrija') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>
                       <div class="col-md-4 col-12">
                       ...
                       <div class="col-md-4 col-12">
                            ...
                            <input wire:model="beginning" type="date" class="form-control" id="beginning">@error('beginning') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>
                       <div class="col-md-4 col-12">
                            <label class="form-label" for="end">Fecha Fin</label>
                            <input wire:model="end" type="date" class="form-control" id="end">@error('end') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>
                       <div class="col-md-4 col-12">
                            <label class="form-label" for="morning_schedule">Horario Mañana</label>
                            <input wire:model="morning_schedule" type="text" class="form-control" id="morning_schedule" placeholder="Horario Mañana">@error('morning_schedule') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>
                       <div class="col-md-4 col-12">
                            <label class="form-label" for="afternoon_schedule">Horario Tarde</label>
                            <input wire:model="afternoon_schedule" type="text" class="form-control" id="afternoon_schedule" placeholder="Horario Tarde">@error('afternoon_schedule') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>
                        <div class="form-group col-3">
                            <label class="form-label">Dias de Impartición</label>
                            <br>
                            <label class="form-label" for="monday"><input wire:model="monday" id="monday" type="checkbox" id="monday" value="monday"> Lunes</label>
                            @error('monday') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>
                        <div class="form-group col-3">
                            <br>
                            <label class="form-label" for="tuesday"><input wire:model="tuesday" id="tuesday" type="checkbox" id="tuesday" value="tuesday"> Martes</label>
                            @error('tuesday') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>
                        <div class="form-group col-3">
                            <br>
                            <label class="form-label" for="wednesday"><input wire:model="wednesday" id="wednesday" type="checkbox" id="wednesday" value="wednesday"> Miercoles</label>
                            @error('wednesday') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>
                        <div class="form-group col-3">
                            <br>
                            <label class="form-label" for="thursday"><input wire:model="thursday" id="thursday" type="checkbox" id="thursday" value="thursday"> Jueves</label>
                            @error('thursday') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>
                        <div class="form-group col-3">
                            <br>
                            <label class="form-label" for="friday"><input wire:model="friday" id="friday" type="checkbox" id="friday" value="friday"> Viernes</label>
                            @error('friday') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>
                        <div class="form-group col-3">
                            <br>
                            <label class="form-label" for="saturday"><input wire:model="saturday" id="saturday" type="checkbox" id="saturday" value="saturday"> Sabado</label>
                            @error('saturday') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>
                        <div class="form-group col-3">
                            <br>
                            <label class="form-label" for="sunday"><input wire:model="sunday" id="sunday" type="checkbox" id="sunday" value="sunday"> Domingo</label>
                            @error('sunday') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>
                       <div class="col-md-4 col-12">
                            <br>
                            <label class="form-label" for="outsourced"><input wire:model="outsourced" id="outsourced" type="checkbox" id="outsourced" value="outsourced"> Subcontratado</label>
