<div class="card">
    <div class="card-header border-bottom">
        <h4 class="card-title">Grupos de Cotización</h4>
        ...
        @endif
        @include('livewire.quote-groups.create')
        @include('livewire.quote-groups.update')
    </div>
        ...
        <div class="row g-1 mb-md-1">
            ...
            <div class="col-md-4">
                <div wire:ignore class="btn btn-sm btn-info" data-bs-toggle="modal" data-bs-target="#createDataModal">
                    <i class="fa fa-plus" class="me-50"></i> Añadir Grupo de Cotización
                </div>
            </div>
        </div>
    </div>
        ...
        document.addEventListener('livewire:load', function () {
            $('body').on('click', '.eliminar', function () {
                ...
                swalWithBootstrapButtons.fire({
                    title: '¿Estas seguro?',
                    text: "Eliminaras al grupo de cotización!",
                    icon: 'warning',
