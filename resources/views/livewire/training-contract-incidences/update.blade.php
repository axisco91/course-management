    ...
    <form>
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-3 mb-1">
                <div wire:ignore>
                    <label class="form-label" for="training_contract_id">Contratos</label>
                    <select wire:model.lazy="training_contract_id" class="form-select select2 @error('training_contract_id') is-invalid @enderror" id="training_contract_id" disabled>
                        <option value="-1">Seleccione una empresa</option>
                        @foreach($training_contracts as $training_contract)
                            <option value="{{$training_contract['id']}}">{{$training_contract['number_cfa']}}</option>
                        @endforeach
                    </select>
                </div>
                @error('training_contract_id') <div class="invalid-feedback">Contrato es requerido</div> @enderror
            </div>
        ...
        <div class="col-12">
            <a href="{{url('/training_contract_incidences/'.$training_contract_id)}}" class="btn btn-secondary">Volver</a>
            <button id="save" type="button" wire:click.prevent="update()" class="btn btn-primary close-modal">Guardar</button>
        </div>
    </form>
