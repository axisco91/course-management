            ...
            <div class="modal-body pb-5 px-sm-5 pt-50">
                ...
                <ul class="nav nav-tabs">
                    ...
                    <li class="nav nav-tabs">
                        <a class="nav-link {{ $tab == 'training_units' ? 'active' : '' }}" wire:click="$set('tab', 'training_units')" data-bs-toggle="tab" href="#training_units">Unidades Formativas</a>
                    </li>
                </ul>
                @if($tab == 'info')
                ...
                @elseif($tab == 'training_units')
                    <div class="tab-pane container-fluid active" id="training_units">
                        @include('livewire.modules.training_units')
                    </div>
                @endif
            </div>
        </div>
