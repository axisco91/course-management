                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input name="dni" id="dni" type="text" class="form-control round">
                                    </div>
                                </div>
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input name="user" id="user" type="text" class="form-control round">
                                    </div>
                                </div>
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input name="observations" id="observations" type="text" class="form-control round">
                                    </div>
                                </div>
                                <div class="col-12 d-flex justify-content-end">
                                    <a  class="btn btn-success me-1 mb-1" id="saveTeacher">Create</a>
