<div wire:ignore.self class="modal fade" id="teachersTabModal" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered modal-teachers-tab">
            ...
            <div class="modal-body pb-5 px-sm-5 pt-50">
                ...
                @elseif($tab == 'courses')
                    <div class="tab-pane container" id="courses">
                        @include('livewire.teachers.course-list')
                    </div>
                @endif
            </div>
        </div>
