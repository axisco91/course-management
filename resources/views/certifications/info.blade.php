<!-- Modal -->
<div wire:ignore.self class="modal fade" id="certificationTabModal" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body pb-5 px-sm-5 pt-50">
                ...
                <ul class="nav nav-tabs">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ $tab == 'elements' ? 'active' : '' }}" wire:click="$set('tab', 'elements')" data-bs-toggle="tab" href="#elements">Unidades / Modulos</a>
                    </li>
                ...
                @if($tab == 'info')
                    <div class="tab-pane container-fluid active" id="general">
                        @include('livewire.certifications.info')
                    </div>
                @elseif($tab == 'elements')
                    <div class="tab-pane container-fluid active" id="elements">
                        @include('livewire.certifications.elements')
                    </div>
                @endif
            </div>
        </div>
