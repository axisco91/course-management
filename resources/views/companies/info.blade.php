<div wire:ignore.self class="modal fade" id="companiesTabModal" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body pb-5 px-sm-5 pt-50">
                ...
                <ul class="nav nav-tabs">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ $tab == 'students' ? 'active' : '' }}"wire:click="$set('tab', 'students')" data-bs-toggle="tab" href="#students">Trabajadores</a>
                    </li>
                    <li class="nav-item">
                ...
                @elseif($tab == 'students')
                    <div class="tab-pane container" id="students">
                        @include('livewire.companies.companies-students')
                    </div>
                @elseif($tab == 'courses')
