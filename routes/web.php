...
use App\Http\Controllers\NewPotentialCompanyController;
...
Route::controller(NewPotentialCompanyController::class)->group(function (){
    route::get('new_potential_company', 'create');
});
